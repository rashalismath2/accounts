<div id="sidebar-cont">
    ...
    <div id="sidebar-items-cont">
        <ul>
            <li><a href="{{route('home')}}"><span class="oi oi-project font-white"></span><p>Dashboard</p></a></li>
            <li><a href="{{route('items')}}"><span class="oi oi-box font-white"></span><p>Items</p></a></li>
